...
window.EasyMDE = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module 'easymde'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
window.voyagerTinyMCE = __webpack_require__(/*! ./voyager_tinymce_config */ "./vendor/tcg/voyager/resources/assets/js/voyager_tinymce_config.js");
...
$(document).ready(function () {
  ...
  $('select.select2-taggable').select2({
    ...
    if (!newTag) return;
    $el.select2('close');
    $.post(route, (_$$post = {}, _defineProperty(_$$post, label, e.params.args.data.text), _defineProperty(_$$post, "_tagging", true), _$$post)).done(function (data) {
  ...
  $.extend(Plugin.prototype, {
    ...
    slug: function slug(str) {
      ...
      for (var i = 0, l = str.length; i < l; i++) {
        _slug += this.chars.hasOwnProperty(str.charAt(i)) ? this.chars[str.charAt(i)] : str.charAt(i);
      }
...
for (var i = 0; i < ace_editor_element.length; i++) {
  ...
  ace.config.set("basePath", $('meta[name="assets-path"]').attr('content') + "?path=js/ace/libs"); // Create an ace editor instance
...
/***/ "./vendor/tcg/voyager/resources/assets/js/voyager_tinymce_config.js":
/*!**************************************************************************!*\
  !*** ./vendor/tcg/voyager/resources/assets/js/voyager_tinymce_config.js ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! D:\project\ptkonline\vendor\tcg\voyager\resources\assets\js\app.js */"./vendor/tcg/voyager/resources/assets/js/app.js");
