...
<div id="app">
    ...
    <v-card>
        ...
        <v-card class="mx-auto mb-1" outlined v-for="(question, i) in questions" :key="i">
            <v-card-text>
                @{{i+1}}. <span class="black--text">@{{question.question_list.value}}</span>
                ...
                <v-row v-else class="mb-n3">
                    <v-col lg="6">
                        <v-textarea disabled :value="question.answer.value" height="100px" outlined dense label="Tulis jawaban" class="black--text">
                        </v-textarea>
                    </v-col>
                </v-row>
