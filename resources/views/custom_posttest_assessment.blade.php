    ...
    methods:{
        ...
        getDataFromApi: function () {
            return new Promise((resolve) => {
                ...
                axios.post(`/admin/posttest/${this.posttest_id}/getcampaignlistpagination?page=${page}&itemsPerPage=${itemsPerPage}`, this.filter_options).then(res => {
                    const {
                        sortBy,
                        sortDesc,
                        // page,
        ...
        submit(){
            ...
            Swal.fire({
                ...
                preConfirm: (login) => {
                    return axios.post('/admin/posttest/campaign/'+this.campaign.id, {questions:this.questions}).then(res=>{
